...
subscription_key = os.getenv("AZURE_OPENAI_API_KEY", "FW3IexoBG4v4NeCRhTzbVVlP5OpxQMki2fTLqkVfP1Hq01f1nMnFJQQJ99BCACHYHv6XJ3w3AAABACOG91xg")

SOURCE_FOLDER = "/workspaces/swayam/files/fileset_FA_IGNOU" # /workspaces/swayam/files/filesetAll
OUTPUT_CSV = "/workspaces/swayam/files/fileset5/0108_FA_IGNOU_lecture_topics_output.csv"
