...
def excel_to_semantic_json(
    ...
    separator: str = ";",
    json_out_path: str = "/workspaces/swayam/result/2106V2All_hierarchical_lecture_topics.json",
...
if __name__ == "__main__":
    file_path = "/workspaces/swayam/files/fileset5/2106Alllecture_topics_output.csv"  # Update as needed
