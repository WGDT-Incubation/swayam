...
def excel_to_semantic_json(
    ...
    separator: str = ";",
    json_out_path: str = "/workspaces/swayam/result/BS/2506_BS_hierarchical_lecture_topics.json",
...
if __name__ == "__main__":
    file_path = "/workspaces/swayam/result/BS/2506_BS_Alllecture_topics_output.csv"  # Update as needed
